...
const uint8_t B1[8] = { 0x0d, 0x57, 0x52, 0x59, 0x49, 0x50, 0x2A, 0x08 };
...
const uint8_t B6[8] = { 0x87, 0x45, 0x54, 0x55, 0x4F, 0x40, 0x5E, 0x51 };
const uint8_t B7[8] = { 0x11, 0xFF, 0x58, 0x56, 0x4E, 0x2C, 0x2F, 0x03 };

const uint8_t SB0[8] = { 0x08, 0x33, 0x35, 0x37, 0x39, 0x2B, 0x1C, 0x31 };
const uint8_t SB1[8] = { 0x0d, 0x57, 0x52, 0x59, 0x49, 0x50, 0x2A, 0x08 };
...
const uint8_t SB6[8] = { 0x87, 0x45, 0x54, 0x55, 0x4F, 0x40, 0x5E, 0x51 };
const uint8_t SB7[8] = { 0x11, 0xFF, 0x58, 0x56, 0x4E, 0x2C, 0x2F, 0x03 };

static char retval;
static uint8_t scanresult[8];
char GETKey(void) {
	__asm__("lda #$FF");
	__asm__("sta %w", DDRB);
	__asm__("sta %w", PORTB);
